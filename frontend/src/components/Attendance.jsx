...
const Attendance = () => {
  ...
  const [todayRec, setTodayRec]     = useState(null);        // own today record
  ...
  return (
    <div style={page}>
      ...
      <div style={headerRow}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
            ...
            <h1 style={h1}>My Attendance</h1>
          </div>
          <p style={subtitle}>{todayStr} · Logged in as <strong style={{ color: '#60a5fa' }}>{username}</strong></p>
        </div>
      ...
      {tab === 'today' && (
        <>
          {/* Status Card */}
          <div style={bigStatusCard(!!todayRec)}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ margin: '4px 0 0', color: '#64748b', fontSize: '13px' }}>
                  {todayRec ? `Clocked in at ${todayRec.checkInTime?.substring(0, 5)}` : 'Use the button below to clock in'}
                </p>
              </div>
            </div>
            ...
            {/* Clock In / Out Buttons — Admin/Manager only */}
      ...
      {tab === 'history' && (
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '14px', marginBottom: '20px' }}>
            ...
            <SummaryMini label="Days Absent"  value={Math.max(0, now.getMonth() + 1 === historyMonth && now.getFullYear() === historyYear ? now.getDate() - daysPresent : daysInMonth - daysPresent)}
...
const SummaryMini = ({ label, value, color, icon }) => (
  <div style={{ backgroundColor: '#1e293b', border: `1px solid ${color}22`, borderRadius: '12px',
...
const loadingStyle = { height: '100vh', backgroundColor: '#0f172a', color: '#a78bfa', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', fontSize: '16px', marginLeft: '240px' };
...
const tabRow      = { display: 'flex', gap: '4px', backgroundColor: '#1e293b', padding: '4px', borderRadius: '10px', border: '1px solid #334155', marginBottom: '24px', width: 'fit-content' };
...
const bigStatusCard = (present) => ({
  backgroundColor: '#1e293b', border: `1px solid ${present ? 'rgba(16,185,129,0.25)' : 'rgba(249,115,22,0.2)'}`,
  borderRadius: '16px', padding: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center'
});
    ...
    <div style={{ marginTop: '20px', backgroundColor: '#1e293b', border: '1px solid #334155', borderRadius: '14px', padding: '22px' }}>
      ...
      {show && (
        <div style={{ marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '12px', maxWidth: '400px' }}>
          ...
          <div>
            <label style={{ color: '#94a3b8', fontSize: '12px', display: 'block', marginBottom: '6px' }}>Current Password</label>
          ...
          <div>
            <label style={{ color: '#94a3b8', fontSize: '12px', display: 'block', marginBottom: '6px' }}>New Password</label>
            <input type="password" value={newPwd} onChange={e => setNewPwd(e.target.value)}
              placeholder="Min 4 characters"
              style={{ width: '100%', padding: '10px', backgroundColor: '#0f172a', border: '1px solid #334155', borderRadius: '8px', color: 'white', outline: 'none', boxSizing: 'border-box' }} />
          </div>
          <div>
            <label style={{ color: '#94a3b8', fontSize: '12px', display: 'block', marginBottom: '6px' }}>Confirm New Password</label>
